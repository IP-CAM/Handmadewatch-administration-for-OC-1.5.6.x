...
class ControllerModuleRelatedOptions extends Controller {
  ...
  public function index()
  {
    ...
    $this->data['entry_spec_price_help'] 					= $this->language->get('entry_spec_price_help');
		$this->data['entry_spec_weight']    					= $this->language->get('entry_spec_weight');
    $this->data['entry_spec_weight_help'] 				= $this->language->get('entry_spec_weight_help');
    ...
    $this->data['entry_spec_price_discount_help'] = $this->language->get('entry_spec_price_discount_help');
		...
		$this->data['entry_import_delete_before']			= $this->language->get('entry_import_delete_before');
