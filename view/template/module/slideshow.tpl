...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
	  ...
	  <b>Плашка под баннером: </b><br><br>
	  Текст: <input type="text" name="text" value="<?php echo $mytimer['text']; ?>" size="30"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  Таймер: <input type="checkbox"  name="enabled" <?php if ($mytimer['enabled']) { echo "checked"; } ?>>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Дата окончания: <input type="text" name="time" value="<?php echo $mytimer['time']; ?>" size="30"/> (дд/мм/гггг чч:мм)         
	  </form>
    </div>
  </div>
</div>
