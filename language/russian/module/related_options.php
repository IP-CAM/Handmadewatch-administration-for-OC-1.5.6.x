<?php
// Heading
$_['heading_title']         = 'Связанные опции_feofan.net';
$_['related_options']       = 'Связанные опции_feofan.net'; 
...
$_['entry_spec_weight']               = 'Вес в связанных опциях';
$_['entry_spec_weight_help']          = 'указывать разные вес для разных сочетаний связанных опций (будет использоваться при расчете веса товара в заказе)';
