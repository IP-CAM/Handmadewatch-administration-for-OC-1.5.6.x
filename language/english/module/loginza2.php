<?php
// Heading
$_['heading_title']       = 'Логинза (платный модуль)_feofan.net';
...
$_['text_showtype_notice']	= 'Модальное окно не открывается на странице /index.php?route=checkout/checkout - там будет простое перенаправление на сайт логинзы';
